...
https://youtu.be/XdZeg3iP5BM?t=277
...
# See https://docs.djangoproject.com/en/2.1/howto/deployment/checklist/  whitenoise==5.2.0

# SECURITY WARNING: keep the secret key used in production secret!


SECRET_KEY = os.getenv('SECRET_KEY', ')s3plx+hb5=@9z8em)fsl81q1vwu!fxwflhhz^dp2$mienlxa-')
